...
export const ALL_FEATS: Feat[] = [
    ...
    },
    {
        ...
        name: "Верховой боец",
        nameEn: "Mounted Combatant",
        desc: `Вы получаете следующие преимущества:\n\n*Повышение характеристики*. Увеличьте значение вашей Силы, Ловкости или Мудрости на 1, но не выше 20.\n\n*Удар всадника*. Будучи верхом, вы совершаете с Преимуществом броски атак по пешим существам в пределах 5 футов от вашего скакуна, если они хотя бы на один размер меньше вашего скакуна.\n\n*Прыжок в сторону*. Если ваш скакун попадает под эффект, позволяющий совершить спасбросок Ловкости для снижения получаемого урона вдвое, то он вовсе не получает урон при успехе и получает всего половину урона при провале. Вы должны быть верхом на скакуне, чтобы он мог воспользоваться этим преимуществом, и вы оба не должны иметь состояние Недееспособный.\n\n*Вираж*. Пока вы верхом и не имеете состояния Недееспособный, вы можете сделать так, что попадающая по вашему скакуну атака вместо этого попадёт по вам.`,
        effect: [
            {
                name: "Повышение характеристики",
                desc: "Увеличьте значение вашей Силы, Ловкости или Мудрости на 1, но не выше 20.",
                choices: [
                    {
                        type: "ability",
                        count: 1,
     ...
     {
        key: "fighting-initiate",
        source: "PH14",
        name: "Посвящённый в боевое искусство",
        nameEn: "Fighting initiate",
        desc: `Ваши боевые тренировки помогли вам разработать особый стиль боя. Теперь вам известен один вариант боевого стиля по вашему выбору из класса воина. Если вам уже известен боевой стиль, то вы должны выбрать стиль, отличный от вашего.\n\nКаждый раз, когда вы достигаете определённого уровня и получаете умение «Увеличение характеристик», вы можете заменить боевой стиль от этой черты на другой из класса воина, который вы не знаете.`,
        effect: [
            {
                name: "Повышение характеристики",
                desc: "Увеличьте значение вашей Силы, Ловкости или Мудрости на 1, но не выше 20.",
    ...
    //},
    {
        key: "fey-teleportation-legacy",
        source: "XGE",
        name: "Телепортация фей",
        nameEn: "Fey Teleportation",
        isLegacy: true,
        desc: `Изучение знаний высших эльфов открыло вам силу фей, которой владеют немногие эльфы, за исключением ваших собратьев эладринов. Опираясь на свое родство с феями, вы можете на мгновение пройти через Страну Фей, сократив свой путь. Вы получаете следующие преимущества:`,
        effect: [
            {
                name: "Повышение характеристики", 
                desc: "Увеличьте значение вашего Интеллекта, Мудрости или Харизмы на 1, но не выше 20.",
                choices: [
                    {
                        type: "ability",
                        count: 1,
            ...
            {
                name: "Языки",
                desc: "Вы изучаете как читать, говорить и писать на Сильване.",
                choices: [
                    {
                        type: "language",
                        count: 1,
            ...
            {
                name: "Заклинания", 
                desc: "Вы изучаете заклинание туманный шаг [misty step] и можете наложить его один раз без использования ячейки заклинания. Вы восстанавливаете возможность накладывать его таким образом, когда завершаете короткий или продолжительный отдых. Интеллект – базовая характеристика для этого заклинания.",
                choices: [
                    {
                        type: "spell",
                        count: 1,
                    options: ["misty-step-legacy"],
                    }
                ],
            },
        ],
