...
export const Fighter: ClassInfo = {
  ...
  mainStats: ["Сила", "Телосложение"],
    ...
    choices: [{ type: "skill", count: 2, options: ["acrobatics", "animal-handling", "athletics", "history", "insight", "intimidation", "perception", "survival"] }],
  ...
  features: {
    1: [
                ...
                choices: [
                    {
                        type: "feature",
                        count: 1,
                        options: ["fighting-style"]
                    }
                ],
            },
            {
                name: "Второе дыхание",
                desc: `У вас есть ограниченный резерв выносливости, который вы можете использовать для защиты себя от травм. В свой ход вы можете бонусным действием восстановить Хиты, равные 1к10 + ваш уровень Воина.\n\nКак только вы использовали это умение, вы должны завершить Короткий или Долгий отдых, прежде чем сможете использовать его снова.`
            },
        ],
        2: [
            {
                name: "Всплеск действий",
                desc: `Вы можете временно выйти за пределы обычных ограничений, накладываемых на вас в бою. В свой ход вы можете совершить одно дополнительное действие.\n\nКак только вы использовали это умение, вы должны завершить Короткий или Долгий отдых, прежде чем сможете использовать его снова. Начиная с 17-го уровня, вы можете использовать его дважды между отдыхами, но только один раз в ход.`
            },
        ],
        3: [
            {
                name: "Архетип воина",
                desc: "Вы выбираете архетип, который отражает ваш стиль боя и ваши цели. Выберите один из следующих вариантов. Вы всегда получаете все умения архетипа, уровень которых не больше вашего уровня Воина.",
                choices: [
                    {
                        type: "subclass",
                        count: 1,
        ...
        5: [
            {
                ...
                desc: "Вы можете совершить две атаки вместо одной, когда используете действие Атака в свой ход."
            },
        ],
        6: [
            {
        ...
        7: [
            {
                name: "Умение архетипа",
                desc: "Вы получаете умение, определяемое выбранным вами архетипом воина."
            },
        ],
        8: [
            {
        ...
        11: [
            {
                name: "Дополнительная атака (улучшенная)",
                desc: "Вы можете совершить три атаки вместо одной, когда используете действие Атака в свой ход."
            },
        ],
        12: [
            {
        ...
        20: [
            {
                name: "Дополнительная атака (легендарная)",
                desc: "Вы можете совершить четыре атаки вместо одной, когда используете действие Атака в свой ход."
            },
        ],
    },
