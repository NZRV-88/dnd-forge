        ...
        },
        {
            ...
            features: {
                ...
                7: [{ 
                    ...
                    desc: "Ваша сверхъестественная сосредоточенность помогает вам предотвратить бегство врага. Когда вы попадаете по существу Провоцированной атакой, вы можете уменьшить его Скорость до 0 до конца текущего хода. Затем частью этой же Реакции вы можете переместиться на расстояние вплоть до половины вашей Скорости; это перемещение не вызывает Провоцированных атак." 
                }],
                15: [{ 
                    name: "Душа мести", 
                    desc: `Немедленно после того, как существо под эффектом вашего Обета вражды попадает или промахивается броском атаки, вы можете Реакцией совершить по нему рукопашную атаку, если оно в пределах вашей досягаемости.` 
                }],
                20: [{ 
                    name: "Ангел отмщения", 
                    desc: `Бонусным действием вы получаете описанные ниже преимущества на 10 минут или пока вы не окончите их (действий не требуется). Как только вы использовали это умение, не можете сделать это вновь, пока не завершите Долгий отдых. Вы также можете восстановить его использование, потратив ячейку заклинаний 5-го уровня (действий не требуется).\n\n*Полёт*. За вашей спиной вырастают призрачные крылья; у вас есть Скорость полёта 60 футов (вы можете парить).\n\n*Ужасающая аура*. Каждый раз, когда враг начинает свой ход в вашей Ауре защиты, он должен преуспеть в спасброске Мудрости, иначе получит состояние Испуганный на 1 минуту или пока не получит урон. Броски атаки по существу с этим состоянием совершаются с Преимуществом.` 
                }],
            },
        },
        {
            key: "oath-of-the-dragonlord",
            name: "Клятва повелителя драконов",
            nameEn: "Oath of the Dragonlord",
            source: "ODL",
            desc: "Стремление к превосходству и власть над драконами.",
            features: {
                3: [
                    { 
                        name: "Заклинания Клятвы повелителя драконов", 
                        desc: "Магия вашей клятвы гарантирует, что у вас всегда будут подготовлены определённые заклинания; с момента достижения вами определенного уровня Паладина, у вас всегда будут подготовлены соответствующие этому уровню заклинания.", 
                        preparedSpells:[
                            {
                                level: 3,
                                spells: ["find-familiar", "hunters-mark"],
                            },
                            {                            
                                level: 5,
                                spells: ["gust-of-wind", "levitate"],                              
                            },
                            {                      
                                level: 9,
                                spells: ["fly", "haste"],
                            ...
                            {
                                level: 17,
                                spells: ["hold-monster", "rarys-telepathic-bond"],
                            },
                        ],
                    },
                    { 
                        name: "Гнев Дракона", 
                        desc: `Действием вы можете имитировать ужасное присутствие дракона, используя божественный канал. Вы издаете такой же громкий рев, как взрослый дракон. Каждое существо на ваш выбор, находящееся в пределах 60 футов от вас и знающее о вашем присутствии, должно преуспеть в спасброске Мудрости со Сл 14, иначе станет испуганным на 1 минуту. Существо может повторять спасбросок в конце каждого своего хода, заканчивая эффект на себе в случае успеха.` 
                    },
                    { 
                        name: "Презрение к недостойным", 
                        desc: `Клятва повелителя драконов возвышает вас над множеством развращенных и слабых. Действием вы можете произнести клятву Повелителя Драконов, используя божественный канал. Вражеские существа в пределах 30 футов от вас, Большого размера или меньше, должны преуспеть в спасброске Харизмы. При провале существо сбивается с ног и теряет концентрацию на всех заклинаниях, которые оно поддерживало активными.` 
                    },
                ],
                
                7: [{ 
                    name: "Узы Повелителей Драконов", 
                    desc: "На 7-м уровне из вашего яйца вылупится дракон. Вы должны наложить заклинание узы Повелителей Драконов и прикоснуться к новорожденному вирмлингу в течение 24-х часов после его появления на свет. Драконий детеныш теперь связан с вами. Кроме того, наложение уз Повелителей Драконов и погребального плача Повелителей Драконов не требует материальных компонентов. Хиты вашего вирмлинга равны 40 + двойное значение вашего уровня паладина. Он добавляет ваш бонус мастерства к своим спасброскам." 
                }],
                15: [{ 
                    name: "Молодой дракон", 
                    desc: `К 15-му уровню ваш дракон превращается в молодого дракона соответствующего типа, если еще не прошло пять лет с момента его рождения. Теперь он позволит использовать себя в качестве верхового животного. Кроме того, находясь на драконе, вы получаете его сопротивление к типам урона, иммунитет к типам урона и чувства (слепое зрение, темное зрение и его пассивное восприятие, если оно больше вашего).` 
                }],
                20: [{ 
                    name: "Нерушимая связь", 
                    desc: `К 20-му уровню вы с драконом научились согласованно сражаться на поле битвы. Ваш дракон получает доступ к своей способности Мультиатака, и его оружие дыхания теперь перезаряжается по обычным правилам, каждый раунд вместо ограничения, описанного в Узах Повелителей Драконов.\n\nКроме того, проваленный вашим драконом спасбросок вы можете сделать успешным. Эта способность перезаряжается после того, как вы и дракон завершите продолжительный отдых.` 
                }],
            },
        },
    ],
