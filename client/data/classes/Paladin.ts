                ...
                3: [
                    { 
                        ...
                        preparedSpells:[
                            {
                                level: 3,
                                spells: ["hunters-mark", "bane"],
                            },
                            {                            
                                level: 5,
                                spells: ["misty-step", "hold-person"],                              
                            },
                            {                      
                                level: 9,
                            ...
                            {
                                level: 17,
                                spells: ["scrying", "hold-monster"],
                            },
                        ],
                    },
                    { 
                        name: "Обет вражды", desc: `Когда вы совершаете действие Атака, можете потратить одно использование вашего Проведения божественности, чтобы дать Обет вражды видимому вами в пределах 30 футов от вас существу. Вы совершаете с Преимуществом броски атаки по этому существу в течение 1 минуты или пока снова не используете это умение.\n\nЕсли Хиты этого существа опускаются до 0 до окончания обета, вы можете перенести обет на другое существо в пределах 30 футов от вас (действий не требуется).` 
                    },
                ],
                7: [{ name: "Неумолимый мститель", desc: "Ваша сверхъестественная сосредоточенность помогает вам предотвратить бегство врага. Когда вы попадаете по существу Провоцированной атакой, вы можете уменьшить его Скорость до 0 до конца текущего хода. Затем частью этой же Реакции вы можете переместиться на расстояние вплоть до половины вашей Скорости; это перемещение не вызывает Провоцированных атак." }],
                15: [{ name: "Душа мести", desc: "Немедленно после того, как существо под эффектом вашего Обета вражды попадает или промахивается броском атаки, вы можете Реакцией совершить по нему рукопашную атаку, если оно в пределах вашей досягаемости." }],
                20: [{ name: "Ангел отмщения", desc: `Бонусным действием вы получаете описанные ниже преимущества на 10 минут или пока вы не окончите их (действий не требуется). Как только вы использовали это умение, не можете сделать это вновь, пока не завершите Долгий отдых. Вы также можете восстановить его использование, потратив ячейку заклинаний 5-го уровня (действий не требуется).\n\n*Полёт*. За вашей спиной вырастают призрачные крылья; у вас есть Скорость полёта 60 футов (вы можете парить).\n\n*Ужасающая аура*. Каждый раз, когда враг начинает свой ход в вашей Ауре защиты, он должен преуспеть в спасброске Мудрости, иначе получит состояние Испуганный на 1 минуту или пока не получит урон. Броски атаки по существу с этим состоянием совершаются с Преимуществом.` }],
            },
        },
        {
            key: "oath-of-glory",
